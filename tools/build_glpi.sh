...
# CI containers (ghcr.io/glpi-project/githubactions-php) export GLPI_ENVIRONMENT_TYPE=testing,
# which would make the kernel load test-only resources and write its cache into tests/files.
